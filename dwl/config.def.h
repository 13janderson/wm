...
static const Rule rules[] = {
    ...
    {"chrome", "chatgpt", 1 << 1, 1, 0, 0, -1}, /* Start chatgpt on ONLY tag "2" */
    // Just new tabs
...
static const enum libinput_config_accel_profile trackpad_accel_profile =
    LIBINPUT_CONFIG_ACCEL_PROFILE_ADAPTIVE;
static const double trackpad_accel_speed = 0.6;
...
static const char *bemenucmd[] = {
    "bemenu-run", "--fn", "JetBrainsMono Nerd Font 22", "-l", "10", NULL};
...
static const Key keys[] = {
    ...
    // SHCMD("/home/tony/scripts/snip.sh") },
    {MODKEY, XKB_KEY_j, focusstack, {.i = +1}},
    {MODKEY, XKB_KEY_k, focusstack, {.i = -1}},
    {MODKEY | WLR_MODIFIER_SHIFT, XKB_KEY_S, spawn,
     SHCMD("geom=\"$(slurp -f '%x,%y %wx%h')\"; grim -l 0 -g \"$geom\" - | "
           "wl-copy")},
    {MODKEY, XKB_KEY_r, togglebar, {0}},
